  ...
  <body>
    <header class="header">
      <div class="contenedor contenido-header">
        ...
        <!-- AL PONERLE UN #"nombre" en el href del link, hace que se diriga hacia un ID con ese nombre -->
    ...
    <div class="video">
      <div class="overlay">
        <div class="contenedor contenido-video">
          ...
          <p>Julio 2022, Apatzingán,Michoacán</p>
        </div>
      </div>
    ...
    <section class="contenedor sobre-festival">
      <div class="imagen">
        <picture>
          ...
          <img
            ...
            width="200"
            height="300"
            src="build/img/imagen_vocalista.jpg"
      ...
      <div class="contenido-festival">
        <h2>Rock & EDM Festival</h2>
        <p class="fecha">Julio 2022, Apatzingán, Michoacán.</p>
        <p>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aperiam iste
          eum fugit, consectetur voluptatum quisquam minima et sapiente
          dignissimos voluptatibus? Quod sint omnis officiis alias aliquam nulla
          itaque voluptatum voluptates.
        </p>
      </div>
    </section>

    <!-- AQUÍ EMPIEZA EL LINE UP--------------- -->
    <section id="lineup" class="lineup">
      ...
      <!-- AQUÍ TERMINA ESCENARIO ROCK -->
      

      <p class="dia">Sabado 22</p>
      <div class="escenarios-contenedor contenedor">
    ...
    <!-- AQUÍ TERMINA ESCENARIO -->

    <!-- AQUÍ EMPIEZA GALERIA -->
        ...
        <h3>Boletos</h3>
          ...
          <div class="contenedor contenedor-boletos">
              <div class="basico pase">
                <p class="nombre-pase">Pase 1 Día</a></p>
                  ...
                  <header class="pase-header">
                      ...
                      <div class="pase-body">
                          <ul>
                            ...
                            <li>Acceso a zonas VIP</li>
                          </ul>
                      </div>

                  <footer class="pase-footer">
                      <p class="parrafo-footer">$180</p>
                  </footer>
              </div>
          </div>
      </section>
